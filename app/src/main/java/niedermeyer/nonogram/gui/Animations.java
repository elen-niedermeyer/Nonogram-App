...
//     *
//     * @param pActivity an instance of {@link GameActivity}
//     */
//    public void showWonAnimation(final GameActivity pActivity) {
//        final ScrollView gameView = (ScrollView) pActivity.findViewById(R.id.activity_game_scroll_vertical);
//        final LinearLayout animatedView = (LinearLayout) pActivity.findViewById(R.id.activity_game_animation_won);
