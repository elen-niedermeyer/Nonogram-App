...
/**
 * @author Elen Niedermeyer, last modified 2017-08-09
 */
public class HowToPlayActivity extends AppCompatActivity implements OnClickListener {

    /**
     * Constant for the position of the table, second element in root layout
     */
    private static final int INDEX_POSITION_TABLE = 1;
     ...
     * Sets the layout. Iitializes the views {@link #root}, {@link #instruction} and {@link #clickText}.
